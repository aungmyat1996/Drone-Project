...
def move_drone_based_on_position(obj_x, obj_y, center_x, center_y):
    ...
    if obj_x < center_x - 50:
        vehicle.channels.overrides['yaw'] = 1500 + DRONE_SPEED
    elif obj_x > center_x + 50:
        vehicle.channels.overrides['yaw'] = 1500 - DRONE_SPEED
    else:
        vehicle.channels.overrides['yaw'] = 1500

    if obj_y < center_y - 50:
        vehicle.channels.overrides['pitch'] = 1500 - DRONE_SPEED
    elif obj_y > center_y + 50:
        vehicle.channels.overrides['pitch'] = 1500 + DRONE_SPEED
    else:
        vehicle.channels.overrides['pitch'] = 1500
