...
# Function to hover the drone if no target is found for a certain period
def hover_drone():
    """Make the drone hover by resetting channel overrides."""
    vehicle.channels.overrides = {
        2: 1500,  # Steady pitch
        3: 1500,  # Steady throttle (altitude)
        4: 1500   # Steady yaw
    }
    print("Hovering in place (no target found).")
