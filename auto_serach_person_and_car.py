...
model = YOLO('yolov8s.pt')  # Ensure you have YOLOv8 weights in the same directory
...
# Function to track the target
def track_target(frame):
    target_box = detect_target(frame)  # Get bounding box of detected target
